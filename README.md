...
If succesful the uptime counter will start in the command prompt window. Your gmod will join the swamp cinema server in 20-30 seconds(or rejoin if you are on currently). The rejoin timer will be started and repeat indefinitely every hour until the command prompt is closed.
